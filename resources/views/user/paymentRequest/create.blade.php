    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route("user.paymentRequest.store") }}" id="contactForm" class="row">
            ...
            <div class="mb-3 col-6">
                ...
                <input type="nationalCode" class="form-control @error('nationalCode') is-invalid @enderror" id="nationalCodeInput" name="nationalCode" placeholder="کد ملی خود را وارد کنید">
                @error('nationalCode')
            ...
            <div class="mb-3 col-6">
                ...
                <select class="form-select @error('expenditureCategory') is-invalid @enderror" id="expenditureCategory" name="expenditureCategory">
            ...
            <div class="mb-3 col-6">
                ...
                <input type="text" class="form-control @error('shaba') is-invalid @enderror" id="shabaInput" name="shaba" placeholder="شماره شبا را وارد کنید">
                @error('shaba')
            ...
            <div class="mb-3 col-6">
                ...
                <input type="text" class="form-control @error('amount') is-invalid @enderror" id="amountInput" name="amount" placeholder="مبلغ را وارد کنید">
                @error('amount')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" id="descriptionTextarea" name="description" rows="4" placeholder="پیام خود را وارد کنید"></textarea>
                @error('description')
